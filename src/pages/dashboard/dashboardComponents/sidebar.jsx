...
const Sidebar = () => {
    ...
    return (
        <aside className="absolute h-screen flex">
            <nav
                className={`${open ? 'w-56' : 'w-16'} h-full flex flex-col bg-white border-r shadow-sm transition-all duration-500`}
                onMouseEnter={() => setOpen(true)}
                onMouseLeave={() => setOpen(false)}
            >
                <div className="relative flex flex-col items-center">
                    <div className="p-4 pb-0 pt-4 flex justify-between items-center w-full">
                        <img src={logo} className={`transition-all duration-1000 ${open ? 'block' : 'hidden'} w-16`} alt="Logo Selfie" />
                    </div>
                    <ul className="flex flex-col space-y-3 w-full">
                        <span className={`top-0 items-center transition-all duration-1000 ${open ? 'hidden' : 'block'}`}>
                            <img 
                                src={shortlogo}
                                className="cursor-pointer rounded-full bg-white w-16"
                                alt="Short logo Selfie"
                            />
                        </span>
                        <li className="hover:bg-gray-100 w-full">
                            <a href="#home" className="text-center flex flex-row items-center ms-5 py-3 justify-start text-gray-500 hover:text-black w-full">
                                ...
                                <span className={`ml-4 transition-all duration-1000 ${open ? 'block' : 'hidden'}`}>Home</span>
                            </a>
                        </li>
                        <li className="hover:bg-gray-100 w-full">
                            <a href="#course" className="text-center flex flex-row items-center ms-5 py-3 justify-start text-gray-500 hover:text-black w-full">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24">
                                ...
                                <span className={`ml-4 transition-all duration-1000 ${open ? 'block' : 'hidden'}`}>Course</span>
                            </a>
                        </li>
                        <li className="hover:bg-gray-100 w-full">
                            <a href="#achievement" className="text-center flex flex-row items-center ms-5 py-3 justify-start text-gray-500 hover:text-black w-full">
                                ...
                                <span className={`ml-4 transition-all duration-1000 ${open ? 'block' : 'hidden'}`}>Achievement</span>
                            </a>
                        </li>
                        <li className="hover:bg-gray-100 w-full">
                            <a href="#to-do-list" className="text-center flex flex-row items-center ms-5 py-3 justify-start text-gray-500 hover:text-black w-full">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24">
                                    <g fill="currentColor">
                                ...
                                <span className={`whitespace-nowrap ml-4 transition-all duration-1000 ${open ? 'block' : 'hidden'}`}>To Do List</span>
                            </a>
                        </li>
                    </ul>
                </div>
