      ...
      {dataCard.map((data, index) => (
        ...
        >
          ...
          >
            ...
            >
              <h3 className="px-3 py-1 text-xl font-bold bg-white sm:text-base lg:py-2 lg:px-5 lg:text-3xl rounded-2xl w-fit">
                {data.nameService}
              </h3>
            </div>
            <div
            ...
            >
              ...
              <p className="text-xs font-bold text-black sm:text-2xl md:text-base lg:text-xl 2xl:text-2xl">
                {data.description}
              </p>
            </div>
          </ReactCardFlip>
